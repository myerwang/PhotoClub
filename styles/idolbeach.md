...
# Style: Idol Beach Behind the Scenes

## Source Prompt

采用来源图注 34 明确给出的实写媒介、年代语汇、场景氛围和影像处理。 Use the source-defined 节目、电影、现场花絮或年代照片构图；人物属性、人数与组合由当前任务决定。 依据来源场景使用自然可信的现场照明与相应年代的色彩、颗粒、曝光和劣化质感。
...
- 采用来源图注 34 明确给出的实写媒介、年代语汇、场景氛围和影像处理。
