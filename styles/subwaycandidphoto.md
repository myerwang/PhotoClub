---
style_id: subwaycandidphoto
name: Subway Candid Photo Prompt
thumbnail: subwaycandidphoto.png
...
# Style: Subway Candid Photo Prompt

## Source Prompt

A {argument name="subject" default="beautiful woman"} looking at her phone {argument name="location" default="on the subway"}; a {argument name="style" default="candid photo"}
...
- 采用来源 prompts.json 条目 15566“Subway Candid Photo Prompt”明确给出的摄影媒介、场景、材质与后期处理，不添加来源外的风格元素。
