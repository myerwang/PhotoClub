---
style_id: candidsubwaycommuter
name: Candid Subway Commuter Prompt
thumbnail: candidsubwaycommuter.png
...
# Style: Candid Subway Commuter Prompt

## Source Prompt

A {argument name="subject" default="beautiful woman"} looking at {argument name="object" default="her phone"} on the {argument name="location" default="subway"}; a candid photo.
...
- 采用来源 prompts.json 条目 14739“Candid Subway Commuter Prompt”明确给出的摄影媒介、场景、材质与后期处理，不添加来源外的风格元素。
