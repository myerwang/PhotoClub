...
style_id: driveway
name: 豪车俯拍
thumbnail: driveway.png
source_url: https://evolink.ai/gpt-image-2-prompts
source_title: GPT Image 2 Prompts
source_result: 1
retrieved_at: 2026-06-19T06:26:49.522Z
---

# Style: Luxury Driveway Portrait
...
- 删除固定性别、年龄、族裔、身份、人数及五官文字描述，改由所选人物参考决定。
- 保留来源中的摄影语言、场景、构图、服装语言、灯光和后期质感；输出比例由 PhotoClub 格式规则决定。

## Visual Rules

- 超写实 DSLR 奢华生活方式摄影，材质和反射清晰。
- 高端住宅车道、石材铺装、草地和热带植物构成环境。

## Composition

- 高角度俯拍、竖幅全身，人物居中站在车辆前部附近。

## Lighting And Color

- 柔和扩散的午后自然光、真实阴影和高级电影调色。
