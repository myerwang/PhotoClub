...
- 删除固定国籍、性别、姓名、人物作品身份及五官文字描述，人物身份由所选人物参考决定。
- 删除固定分辨率、片名、导演、年代文案和文字准确率；保留来源明确给出的服装展示、海报结构、场景、色彩、构图与印刷质感。

## Visual Rules

- 采用来源代码块 1 明确给出的高保真摄影、版式结构、材质和印刷视觉。

## Composition

- 采用来源提示词明确指定的人物与服装分解网格，或上半部人物近景和下部标题区；人物属性、人数与组合由当前任务决定。

## Lighting And Color

- 采用来源提示词指定的柔和自然光、怀旧漫射光或服装目录棚拍光，以及克制的年代色彩。
